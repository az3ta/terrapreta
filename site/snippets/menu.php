<header class="grid grid-cols-12 items-center fixed top-0 left-0 w-full p-4 text-lg z-10">
  <menu class="flex flex-row space-x-2 col-start-1 col-end-auto">
    ...
    <li class="hidden sm:block border border-black px-1.5 py-0 hover:bg-tp-orange <?php e($item->isOpen(), ' bg-tp-orange ', ' bg-white ') ?>">
    ...
    <li class="hidden sm:block uppercase border border-black px-1.5 py-0 bg-white hover:bg-tp-orange rounded-full <?php e($kirby->language() === $language, ' active') ?>">
  ...
  <!-- Mailing list -->
  <a class="hidden sm:block ml-onclick-form border-0 py-0 hover:text-tp-orange col-start-11 col-end-13 text-right whitespace-nowrap" href="javascript:void(0)" onclick="ml('show', 'qpgWFo', true)">Join our mailing list</a>
</header>
